...
public:
	...
	{
		windowTitle = "Ray tracing reflections";
		timerSpeed *= 0.5f;
	...
	*/
	void createBottomLevelAccelerationStructure()
	{
		...
		scene.loadFromFile(getAssetPath() + "models/reflection_scene.gltf", vulkanDevice, graphicQueue, glTFLoadingFlags);
	...
	*/
	void createDescriptorSets()
	{
		...
		std::vector<VkWriteDescriptorSet> writeDescriptorSets = {
			...
			vks::initializers::writeDescriptorSet(descriptorSet, VK_DESCRIPTOR_TYPE_UNIFORM_BUFFER, 2, &ubo.descriptorBufferInfo),
	...
	*/
	void createRayTracingPipeline()
	{
		std::vector<VkDescriptorSetLayoutBinding> setLayoutBindings = {
			...
			vks::initializers::GenDescriptorSetLayoutBinding(VK_DESCRIPTOR_TYPE_STORAGE_BUFFER, VK_SHADER_STAGE_CLOSEST_HIT_BIT_KHR, 3),
			// Binding 4: Index buffer
			vks::initializers::GenDescriptorSetLayoutBinding(VK_DESCRIPTOR_TYPE_STORAGE_BUFFER, VK_SHADER_STAGE_CLOSEST_HIT_BIT_KHR, 4),
		};
