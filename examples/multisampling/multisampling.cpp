...
public:
	...
	void setupMultisampleTarget()
	{
		...
		// Color target
		VkImageCreateInfo info = vks::initializers::GenImageCreateInfo();
		...
		memAlloc = vks::initializers::GenMemoryAllocateInfo();
		memAlloc.allocationSize = memReqs.size;
	...
	void loadAssets()
	{
		model.loadFromFile(getAssetPath() + "models/voyager.gltf", vulkanDevice, graphicQueue, vkglTF::FileLoadingFlags::PreTransformVertices | vkglTF::FileLoadingFlags::FlipY);
	}
