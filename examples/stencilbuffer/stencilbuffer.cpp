...
public:
	...
	{
		windowTitle = "Stencil buffer outlines";
		timerSpeed *= 0.25f;
	...
	void loadAssets()
	{
		model.loadFromFile(getAssetPath() + "models/venus.gltf", vulkanDevice, graphicQueue, vkglTF::FileLoadingFlags::PreTransformVertices | vkglTF::FileLoadingFlags::FlipY);
	}
